...
import { type ProductCard as ProductCardType } from '@elare/types';
import { cn, socialProof } from '@elare/utils';
import { fadeUp, Badge, Price, Rating, Swatch } from '@elare/ui';
import { useStoreConfig, useAddToCart } from '@/lib/hooks';
