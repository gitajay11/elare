...
import { fadeUp, imageReveal, stagger, viewportOnce, useAuth, Button, Price, Rating, SectionHeading, Stars, Swatch } from '@elare/ui';
import { imageUrl, money } from '@elare/utils';
