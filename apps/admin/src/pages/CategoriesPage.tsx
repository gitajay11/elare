...
import { slugify } from '@elare/utils';
import { toast, Button, Input, Textarea, Toggle, Badge, Skeleton, Modal, Confirm } from '@elare/ui';
...
export default function AdminCategories() {
  ...
  const save = useMutation({
    mutationFn: async (e: Editing) => { if (e.kind === 'category') await adminApi.saveCategory(e.row); else await adminApi.saveSubcategory(e.row); },
